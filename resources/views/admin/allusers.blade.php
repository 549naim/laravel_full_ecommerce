      ...
      <div>
        ...
        <table>
            ...
            <tr>
              ...
              <td>{{$item->p_number}}</td>
              @if($item->role_as == '0')
              <td class="badge bg-success m-3" >User</td>
              @else
              <td class="badge bg-warning text-dark m-3">Admin</td>
              @endif 
              
             
              <td ><a href="{{ url('user_details_from_admin/'.$item->id) }}" class="btn btn-primary">User Details</a>
